function initializePage(controller) {
    ...
    var links = [
        ...
        { selector: '.download-resume', href: '/waldenResume.docx', anchorText: 'Download resume as a Word document' },
    ];
    ...
    if (controller == "contact" || controller == "resume") {
        ...
        //set download resume link
        if (controller == "resume") {
            $('.download-resume').html('<a href="/waldenResume.docx">Download resume as a Word document</a>');
        }
    }   
}
